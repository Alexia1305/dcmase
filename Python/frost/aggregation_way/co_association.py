...
# -----------------------------
def USENC_ConsensusFunction(baseCls, k, maxTcutKmIters=100, cntTcutKmReps=3):
    """
    Combine the M base clusterings in baseCls to obtain the final clustering result (with k clusters).
    """
